...
--
-- Host: localhost
-- Generation Time: Sep 17, 2018 at 05:38 AM
...
--
-- Database: `simple_ecommerce_website`
--

-- --------------------------------------------------------

--
-- Table structure for table `bangladesh_districts`
--

CREATE TABLE `bangladesh_districts` (
...
--
-- Dumping data for table `bangladesh_districts`
--

INSERT INTO `bangladesh_districts` (`id`, `full_name`, `short_name`, `division_id`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `bangladesh_upazilas`
--

CREATE TABLE `bangladesh_upazilas` (
  `id` int(10) UNSIGNED NOT NULL,
  `full_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `bangladesh_upazilas`
--

INSERT INTO `bangladesh_upazilas` (`id`, `full_name`, `short_name`, `code`, `district_id`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `categories` (
  ...
  `count_product` int(10) DEFAULT '0',
  `category_sort_order` int(10) DEFAULT '0',
...
INSERT INTO `categories` (`id`, `name`, `image`, `short_description`, `long_description`, `parent_id`, `has_child`, `is_featured`, `level`, `count_product`, `category_sort_order`, `meta_key`, `meta_description`, `created_at`, `updated_at`) VALUES
(1, 'Fruit', '', '', '', 0, 1, 0, 0, 0, 0, '', '', '2016-06-11 16:27:42', '2018-09-03 10:41:36'),
(2, 'Vegetable', '', '', '', 0, 1, 0, 0, 0, 0, '', '', '2016-06-11 16:27:42', '2018-09-10 18:42:54'),
(3, 'Furniture', '', '', '', 0, 1, 0, 0, 0, 0, '', '', '2016-06-11 16:27:42', '2018-09-03 10:41:36'),
(4, 'Smartphone', '', '', '', 0, 1, 0, 0, 0, 0, '', '', '2016-06-11 16:27:42', '2018-09-10 18:43:00');
...
CREATE TABLE `orders` (
  ...
  `order_status` int(10) NOT NULL DEFAULT '0' COMMENT '0=order placed, 1=order started, 2=order completed, 3=order cancelled',
  `deletion_status` int(10) DEFAULT NULL,
  `total_price` float(10,2) DEFAULT '0.00',
  `shipping_amount` float(10,2) DEFAULT '0.00',
  `shipping_country` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `card_expiration_year` int(10) DEFAULT NULL,
  `card_expiration_month` int(10) DEFAULT NULL,
  `card_cvv` int(10) DEFAULT NULL,
  `card_holder_contact_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `price_currency` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `products` (`id`, `name`, `category_id`, `stock`, `price`, `price_currency`, `weight`, `weight_unit`, `sku`, `photo`, `is_featured`, `is_latest`, `short_description`, `long_description`, `created_at`, `updated_at`) VALUES
(1, 'Apple', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'apple_1.png', 0, 0, 'Apple short description.', 'A typical apple serving weighs 242 grams and provides 126 calories with a moderate content of dietary fiber. Apples can be consumed various ways: juice, raw in salads, baked in pies, cooked into sauces, and other baked dishes.', '2018-02-14 05:47:38', '2018-09-14 18:53:02'),
(2, 'Pineapple', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'pineapple_1.png', 0, 0, 'Pineapple short description.', 'In a 100 gram reference amount, raw pineapple is a rich source of manganese (44% Daily Value, DV) and vitamin C (58% DV). Pineapples can be consumed fresh, cooked, juiced, or preserved. They are found in a wide array of cuisines.', '2018-02-14 05:47:38', '2018-09-14 18:53:08'),
(3, 'Orange', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'orange_1.png', 0, 0, 'Orange short description.', 'Orange pulp is an excellent source of vitamin C, providing 64% of the Daily Value in a 100 gram serving. Orange juice contains only about one-fifth the citric acid of lime or lemon juice (which contain about 47 g/l).', '2018-02-14 05:47:38', '2018-09-14 18:53:10'),
(4, 'Mango', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'mango_1.png', 0, 0, 'Mango short description.', 'The energy value per 100 g (3.5 oz) serving of the common mango is 250 kJ (60 kcal).', '2018-02-14 05:47:38', '2018-09-14 18:53:13'),
(5, 'Grape', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'grape_1.png', 0, 0, 'Grape short description.', 'Grape juice is obtained from crushing and blending grapes into a liquid. The juice is often sold in stores or fermented and made into wine, brandy, or vinegar.', '2018-02-14 05:47:38', '2018-09-14 18:53:22'),
(6, 'Banana', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'banana_1.png', 0, 0, 'Banana short description.', 'Raw bananas (not including the peel) are 75% water, 23% carbohydrates, 1% protein, and contain negligible fat. A 100-gram serving supplies 89 Calories, 31% of the US recommended Daily Value of vitamin B6, and moderate amounts of vitamin C, manganese and dietary fiber.', '2018-02-14 05:47:38', '2018-09-14 18:53:32'),
(7, 'Strawberry', 1, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'strawberry_1.png', 0, 0, 'Strawberry short description.', 'One serving (100 g; see Table) of strawberries contains approximately 33 kilocalories, is an excellent source of vitamin C, a good source of manganese, and provides several other vitamins and dietary minerals in lesser amounts. Strawberries contain a modest amount of essential unsaturated fatty acids in the achene (seed) oil.', '2018-02-14 05:47:38', '2018-09-14 18:53:37'),
(9, 'Lemon', 2, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'lemon_1.png', 0, 0, 'Lemon short description.', 'Lemons are a rich source of vitamin C, providing 64% of the Daily Value in a 100 g serving. Other essential nutrients, however, have insignificant content.\r\n\r\nLemons contain numerous phytochemicals, including polyphenols, terpenes, and tannins. Lemon juice contains slightly more citric acid than lime juice (about 47 g/l), nearly twice the citric acid of grapefruit juice, and about five times the amount of citric acid found in orange juice.', '2018-02-14 05:47:38', '2018-09-14 18:53:29'),
(10, 'Tomato', 2, 20, 100.00, 'Taka', 1.00, 'kg', NULL, 'tomato_1.png', 0, 0, 'Tomato short description.', 'A tomato is 95% water, contains 4% carbohydrates and less than 1% each of fat and protein. In a 100 gram amount, raw tomatoes supply 18 calories and are a moderate source of vitamin C (17% of the Daily Value), but otherwise are absent of significant nutrient content.', '2018-02-14 05:47:38', '2018-09-14 18:53:26');
...
INSERT INTO `temp_orders` (`id`, `tracking_number`, `user_id`, `product_id`, `product_name`, `product_price`, `product_quantity`, `created_at`, `updated_at`) VALUES
(1, 'vWPwNgeDTnzO2TxffPp7IxCrsXzumnX2MEiJbrvh', NULL, 1, 'Apple', 100.00, 1, '2018-09-15 01:15:00', '2018-09-15 01:15:00');
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$STN.NUOCWeVTN.1iONJjhuLIKz/uA2b4E8IKUUYaW.qizm4UHVKyi', 1, 'zlSkPnOSgemRI4en6X6YhfocooDR7D7HoBJCrimoomGUwalMIMKxf8bjQtqo', '2018-09-02 13:48:41', '2018-09-14 19:05:25'),
(2, 'Rony', 'rony@gmail.com', '$2y$10$STN.NUOCWeVTN.1iONJjhuLIKz/uA2b4E8IKUUYaW.qizm4UHVKyi', 0, 'h8helKAYRBuFKj7auMV0UG6ZpQ9cOG0VxRwvASd3vc90Yrp4nNpNWJ4XLFu6', '2018-09-02 13:48:41', '2018-09-14 19:20:38');
...
--
-- Indexes for table `bangladesh_districts`
--
ALTER TABLE `bangladesh_districts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bangladesh_upazilas`
--
ALTER TABLE `bangladesh_upazilas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `bangladesh_districts`
--
ALTER TABLE `bangladesh_districts`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `bangladesh_upazilas`
--
ALTER TABLE `bangladesh_upazilas`
