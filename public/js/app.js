		...
		var A = function(e)
		{
			...
			}, p = oe.setDocument = function(e)
			{
				...
				}, m = [], g = [], (n.qsa = X.test(d.querySelectorAll)) && (ue(function(e)
				{
					...
					"+b+" -\r\\" msallowcapture="
					"><option selected="
					"></option></select>", e.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=" + P + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || g.push("\\[" + P + "*(?:value|" + $ + ")"), e.querySelectorAll("[id~=" + b + "-]").length || g.push("~="), e.querySelectorAll(":checked").length || g.push(":checked"), e.querySelectorAll("a#" + b + "+*").length || g.push(".#.+[+~]")
				}), ue(function(e)
				{
					e.innerHTML = "<a href="
					" disabled="
				...
				} : function(e, t)
				{
					...
					if(!i || !o)
					{
						return e === d ? -1 : t === d ? 1 : i ? -1 : o ? 1 : l ? L(l, e) - L(l, t) : 0;
					}
					if(i === o)
					{
						return le(e, t);
					...
					}, CHILD: function(e, t, n, r, i)
					{
						...
						} : function(t, n, u)
						{
							...
							if(g)
							{
								...
								{
									for(; (p = ++d && p && p[v] || (_ = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++_ || (y && ((l = (f = p[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [x, _]), p !== t));)
									{
										;
									}
								}
